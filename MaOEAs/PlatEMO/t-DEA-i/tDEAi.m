...
%     [W,Global.N] = UniformPoint(Global.N,Global.M);
    W = load('rv_das_'+string(Global.M)+'.mat'); % DEXTER
    W = W.RPset; % DEXTER
    sizeofpop = size(W); % DEXTER
    ...
    while Global.NotTermination(Population) 
        ...
        [Population,z,znad] = EnvironmentalSelectioni([Population,Offspring],W,Global.N,z,znad);
    end
end